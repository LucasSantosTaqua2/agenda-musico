...
const tabs = [tabAgenda, tabCalendario, tabSetlists, tabEquipe, tabDashboard, tabConfiguracoes];
const views = [viewAgenda, viewCalendario, viewSetlists, viewEquipe, viewDashboard, viewConfiguracoes];
